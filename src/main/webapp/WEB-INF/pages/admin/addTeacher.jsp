	...
	<!-- 中间主体 -->
		...
		<div class="row">
				...
				<div class="col-md-10">
					<div class="card mb-5">
						<div class="card-body">
							<h2 class="card-title text-center">添加教师</h2>
							<form class="mt-2" action="/admin/addTeacher" id="editfrom" method="post">
								...
								<div class="mb-3 form-floating">
									<select class="form-select" id="xl1" name="degree">
										<option value="本科">本科</option>
										<option value="硕士">硕士</option>
										<option value="博士">博士</option>
									</select>
									<label for="xl1">学历</label>
								</div>
								<div class="mb-3 form-floating">
									<select class="form-select" id="xl2" name="title">
