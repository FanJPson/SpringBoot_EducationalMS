					...
					<div class="card-body">
						...
						<form style="display: inline" action="/admin/selectTeacher?page=1&pageSize=4" id="form1" method="post" class="mt-2">
							<div class="input-group">
								<input type="text" class="form-control" placeholder="输入姓名查找" name="findByName" id="findByName" value="${sessionScope.findTeacherByName}">
						...
						<nav class="mt-3">
							<ul class="pagination justify-content-center">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/admin/selectTeacher?page=${selectTeacherInfo.pageNum-1}&pageSize=${selectTeacherInfo.pageSize}">
								...
								<c:forEach begin="1" end="${selectTeacherInfo.pages}" var="i">
									<c:if test="${i==selectTeacherInfo.pageNum}">
										<li class="page-item active">
											<a class="page-link" href="${pageContext.request.contextPath}/admin/selectTeacher?page=${i}&pageSize=${selectTeacherInfo.pageSize}">${i}</a>
										</li>
									</c:if>
									<c:if test="${i!=selectTeacherInfo.pageNum}">
										<li class="page-item">
