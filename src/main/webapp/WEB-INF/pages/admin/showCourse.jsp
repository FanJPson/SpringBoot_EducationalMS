			...
			<div class="col-md-10">
				<div class="card">
					<div class="card-body">
						...
						<form style="display: inline" action="/admin/selectCourse?page=1&pageSize=4" id="form1" method="post" class="mt-2">
						...
						<nav class="mt-3">
							<ul class="pagination justify-content-center">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/admin/showCourse?page=${CoursePageInfo.pageNum-1}&pageSize=${CoursePageInfo.pageSize}">
								...
								<c:forEach begin="1" end="${CoursePageInfo.pages}" var="i">
									<c:if test="${i==CoursePageInfo.pageNum}">
										<li class="page-item active">
											<a class="page-link" href="${pageContext.request.contextPath}/admin/showCourse?page=${i}&pageSize=${CoursePageInfo.pageSize}">${i}</a>
										</li>
									</c:if>
									<c:if test="${i!=CoursePageInfo.pageNum}">
										<li class="page-item">
